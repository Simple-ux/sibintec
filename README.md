### Task_1 - Первое задание, Task_2 - Второе


### 2 способа решения, за основу взял свое веб-приложение
...
Более экспериментальный, хотелось больше это все автоматизировать.
